...
/// create a login page like we could have on mobile applications, the user
/// can create their account with their email (google) or phone number.
///
/// The background must be white and the buttons 6B4EFF
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (userCredential != null) {
                                if (!mounted) return;
                                context.pushNamed(HomeScreenWidget.routeName); // ou routeName de ta page d'accueil/test
                              } else {
                                if (!mounted) return;
